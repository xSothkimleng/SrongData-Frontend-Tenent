      ...
      <Grid container spacing={3}>
        <Grid item xs={12}>
          <Typography variant="body1" sx={{ display: "inline-block" }}>
            {GetContext("survey_language", lang)}
          </Typography>
          <Box>
            <FormControlLabel
              control={<Checkbox />}
                ...
                <FormControl>
                  ...
                  >
                    <FormControlLabel
                      ...
                      control={<Radio disabled={isEdit && isEdit === true} />}
                      label={GetContext("capi", lang)}
                    />
                    ...
                    <FormControlLabel
                      ...
                      control={<Radio disabled={isEdit && isEdit === true} />}
                      label={GetContext("web_survey", lang)}
                    />
                  </RadioGroup>
                </FormControl>
              </Box>
