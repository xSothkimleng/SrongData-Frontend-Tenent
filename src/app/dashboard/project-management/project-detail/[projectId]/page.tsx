                  ...
                  <Grid item xs={12} sm={6} md={3}>
                    ...
                    <Box sx={{ mt: 1, display: 'flex', flexWrap: 'wrap', gap: 1 }}>
                      {projectDetails.location_details.provinces?.map((province, index) => (
                        <Chip key={index} label={currentLocale === 'en' ? province.name_en : province.name_km} size='small' />
                      ))}
                    </Box>
                  </Grid>
                )}
                  ...
                  <Grid item xs={12} sm={6} md={3}>
                    ...
                    <Box sx={{ mt: 1, display: 'flex', flexWrap: 'wrap', gap: 1 }}>
                      {projectDetails.location_details.districts?.map((district, index) => (
                        <Chip key={index} label={currentLocale === 'en' ? district.name_en : district.name_km} size='small' />
                      ))}
                    </Box>
                  </Grid>
                )}
                  ...
                  <Grid item xs={12} sm={6} md={3}>
                    ...
                    <Box sx={{ mt: 1, display: 'flex', flexWrap: 'wrap', gap: 1 }}>
                      {projectDetails.location_details.communes?.map((commune, index) => (
                        <Chip key={index} label={currentLocale === 'en' ? commune.name_en : commune.name_km} size='small' />
                      ))}
                    </Box>
                  </Grid>
                )}
                  ...
                  <Grid item xs={12} sm={6} md={3}>
                    ...
                    <Box sx={{ mt: 1, display: 'flex', flexWrap: 'wrap', gap: 1 }}>
                      {projectDetails.location_details.villages?.map((village, index) => (
                        <Chip key={index} label={currentLocale === 'en' ? village.name_en : village.name_km} size='small' />
                      ))}
                    </Box>
                  </Grid>
                )}
                ...
                <AccordionSummary
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center' }}>
                    ...
                    <Typography variant='subtitle1'>
                      {GetContext('section_title', currentLocale)} {section.order}:{' '}
                      {currentLocale == 'en' ? section.title.en : section.title.km}
                    </Typography>
                  </Box>
                </AccordionSummary>
                <AccordionDetails sx={{ p: 0 }}>
                                ...
                                {question.skip_logics.map((logic, logicIndex) => {
                                  ...
                                  return (
                                    <Box
                                      ...
                                      <Typography variant='body2'>{logic.action === 'go_to' ? 'Go to' : logic.action}</Typography>
                                      <Chip
                                        label={
                                          targetSection
                                            ? `Section ${targetSection.order}: ${
                                                currentLocale == 'en' ? targetSection.title.en : targetSection.title.km
                                              }`
