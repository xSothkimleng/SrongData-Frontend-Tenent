        ...
        >
          <Box sx={{ display: "flex", alignItems: "center" }}>
            ...
            <Typography variant="h6">
              {GetContext("project_location", currentLocale)}
            </Typography>
          </Box>
        </AccordionSummary>
      ...
      <Card elevation={1} sx={{ mb: 3 }}>
        <CardContent>
          <Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
            ...
            <Typography variant="h6">
              {GetContext("project_questions", currentLocale)}
            </Typography>
          </Box>
          <Divider sx={{ mb: 2 }} />
                          ...
                          {question.options && question.options.length > 0 && (
                            <Grid item xs={12}>
                              <Box sx={{ ml: 4 }}>
                                ...
                                >
                                  {GetContext("option", currentLocale)}
                                </Typography>
                                <Box
                                  sx={{
                                    display: "flex",
                              ...
                              <Grid item xs={12}>
                                <Box sx={{ ml: 4, mt: 1 }}>
                                  <Typography
                                    ...
                                    sx={{ mb: 1, fontWeight: 500 }}
                                  >
                                    {GetContext("skip_logic", currentLocale)}:
                                  </Typography>
                                  {question.skip_logics.map(
                                    (logic, logicIndex) => {
                                      ...
                                      const optionText =
                                        question.options &&
                                        question.options[logic.answer_index]
                                          ? getLocalizedOption(
                                              question.options[
                                                logic.answer_index
                                              ],
                                            ...
                                            label={
                                              targetSection
                                                ? `Section ${targetSection.order}: ${
                                                    currentLocale == "en"
                                                      ? targetSection.title.en
                                                      : targetSection.title.km
                                                  }`
      ...
      <Card elevation={1}>
        <CardContent>
          <Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
            ...
            <Typography variant="h6">
              {GetContext("project_indicator", currentLocale)}
            </Typography>
          </Box>
          <Divider sx={{ mb: 2 }} />
